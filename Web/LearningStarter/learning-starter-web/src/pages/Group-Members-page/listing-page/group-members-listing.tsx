    ...
    return(
        <Segment>
            ...
            <Header>Group Members</Header>
                ...
                <Button type="button" onClick={() => history.push(routes.groupMembers.create)}>+ Create</Button>
                    ...
                    {groupMembers.map((groupMembers) => {
                        return(
                            ...
                            <Table.Cell>
                                ...
                                onClick={() =>
                                history.push(
                                    routes.groupMembers.update.replace(":id", `${groupMembers.id}`)
                                )
                                }
                                />
                            </Table.Cell>
                            ...
                            <Table.Cell>
                                ...
                                history.push(routes.groupMembers.delete.replace(
                                    ":id", `${groupMembers.id}`))}> Delete </Button>
                            </Table.Cell>
                            </Table.Row>
                        );
                    })}
