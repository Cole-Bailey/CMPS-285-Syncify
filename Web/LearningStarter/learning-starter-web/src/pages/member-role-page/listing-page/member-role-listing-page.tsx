...
export const MemberRoleListingPage = () => {
    ...
    return (
        <Segment>
            ...
            <Button type="button" onClick={() => history.push(routes.memberRoles.create)}>+ Create</Button>
                ...
                {memberRoles.map((memberRole) => {
                    ...
                    <Table.Cell>
                        <Icon
                            ...
                            onClick={() =>
                            history.push(
                                routes.memberRoles.update.replace(":id", `${memberRole.id}`)
                            )
                        }
                        />
                    </Table.Cell>
                    ...
                    <Table.Cell>
                        <Icon
                            ...
                            onClick={() =>
                            history.push(
                                routes.memberRoles.delete.replace(":id", `${memberRole.id}`)
                            )
                        }
                        />
                    </Table.Cell>
